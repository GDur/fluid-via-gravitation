...
$$.ReceivePortImpl = {"": "Object;_id>,_liblib1$_callback>",
  _liblib1$_callback$2: function(arg0, arg1) {
    return this._liblib1$_callback.call$2(arg0, arg1);
  },
  receive$1: function(onMessage) {
    this._liblib1$_callback = onMessage;
  },
  close$0: function() {
    this._liblib1$_callback = null;
...
$$.Main = {"": "Object;canvas>,count,context>,_width=,_height<,renderTime,particles>",
  _start$0: function() {
    this.context = this.canvas.get$context2d();
    this.particles = $.Particles$(this.context, this.count);
  ...
  draw$1: function(_) {
    ...
    if (t1 != null) {
      ...
      if (typeof t1 !== "number")
        throw $.iae(t1);
      $.showFps($.CONSTANT11.round$0(1000 / t1));
    }
  ...
  drawBackground$0: function() {
    this.context.clearRect$4(0, 0, this.get$width(), this.get$height());
  },
  get$width: function() {
    return this._width;
  },
  ...
  start$0: function() {
    window.setImmediate$1(new $.Main_start_anon(this));
  }
};
...
$$.v2 = {"": "Object;x>,y>",
  $add: function(v) {
    ...
    if (typeof t3 !== "number")
      return this.$$add$bailout(2, v, t1, t3);
    t3 = t1 + t3;
    t1 = this.y;
    t6 = v.get$y();
    if (typeof t1 !== "number")
      return this.$$add$bailout(3, v, t1, t3);
    if (typeof t6 !== "number")
      return this.$$add$bailout(4, 0, t1, t3, t6);
    return $.v2$(t3, t1 + t6);
  },
  $$add$bailout: function(state0, v, t1, t3, t6) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
  ...
  add$1: function(v) {
    ...
    t6 = v.get$y();
    if (typeof t1 !== "number")
      return this.add$1$bailout(3, v, t1, t3);
    if (typeof t6 !== "number")
      return this.add$1$bailout(4, 0, t1, t3, t6);
    return $.v2$(t3, t1 + t6);
  },
  add$1$bailout: function(state0, v, t1, t3, t6) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
  ...
  $sub: function(v) {
    ...
    if (typeof t3 !== "number")
      return this.$$sub$bailout(2, v, t1, t3);
    t3 = t1 - t3;
    t1 = this.y;
    t6 = v.get$y();
    if (typeof t1 !== "number")
      return this.$$sub$bailout(3, v, t1, t3);
    if (typeof t6 !== "number")
      return this.$$sub$bailout(4, 0, t1, t3, t6);
    return $.v2$(t3, t1 - t6);
  },
  $$sub$bailout: function(state0, v, t1, t3, t6) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
  ...
  $mul: function(v) {
    ...
    t3 = v.get$x();
    if (typeof t1 !== "number")
      return this.$$mul$bailout(1, v, t1);
    if (typeof t3 !== "number")
      return this.$$mul$bailout(2, v, t1, t3);
    t3 = t1 * t3;
    t1 = this.y;
    t6 = v.get$y();
    if (typeof t1 !== "number")
      return this.$$mul$bailout(3, v, t1, t3);
    if (typeof t6 !== "number")
      return this.$$mul$bailout(4, 0, t1, t3, t6);
    return $.v2$(t3, t1 * t6);
  },
  $$mul$bailout: function(state0, v, t1, t3, t6) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
      ...
      case 4:
        state0 = 0;
        return $.v2$(t3, $.$$mul$n(t1, t6));
    }
  },
  multN$1: function(f) {
    return $.v2$($.$$mul$n(this.x, f), $.$$mul$n(this.y, f));
  },
  mag2$0: function() {
    var t1, t2;
    t1 = this.x;
    t1 = $.$$mul$n(t1, t1);
    t2 = this.y;
    return $.$$add$n(t1, $.$$mul$n(t2, t2));
  },
  norm$0: function() {
    var t1, t2, t3, t4, t5, $length;
    t1 = this.x;
    t2 = $.getInterceptor$n(t1);
    t3 = t2.$mul(t1, t1);
    t4 = this.y;
    t5 = $.getInterceptor$n(t4);
    $length = Math.sqrt($.checkNum($.$$add$n(t3, t5.$mul(t4, t4))));
    return $.v2$(t2.$div(t1, $length), t5.$div(t4, $length));
  },
  toString$0: function() {
    return "v2(" + $.S(this.x) + ", " + $.S(this.y) + ")";
  }
};

$$.Particle = {"": "Object;pos=,vel=,m>,radius>",
  r$0: function() {
    return this.radius;
  },
  Particle$2: function(pos, m) {
    var random = $.Random_Random(null);
    this.vel = $.v2$(random.nextDouble$0() * 5 - 2.5, random.nextDouble$0() * 5 - 2.5);
    this.radius = $.sqrt(this.m / 3.141592653589793);
  }
};

$$.Particles = {"": "Object;context>,particles>,count,G>,attraction>,repulsion>,radius>",
  forAll$1: function(fn) {
    var i;
    for (i = 0; $.CONSTANT6.$lt(i, this.count); ++i)
      fn.call$1(i);
  },
  draw$0: function() {
    var t1, i;
    this.G = $.$$div$n($.double_parse($.get$GSlider().get$value(), null), 100);
    this.repulsion = $.$$div$n($.double_parse($.get$repulsionSlider().get$value(), null), 500);
    this.radius = $.double_parse($.get$radiusSlider().get$value(), null);
    this.attraction = $.double_parse($.get$attractionSlider().get$value(), null);
    t1 = new $.Particles_draw_anon(this);
    for (i = 0; $.CONSTANT6.$lt(i, this.count); ++i)
      t1.call$1(i);
    t1 = new $.Particles_draw_anon0(this);
    for (i = 0; $.CONSTANT6.$lt(i, this.count); ++i)
      t1.call$1(i);
  },
  calcVel$1: function(i) {
    var t1 = new $.Particles_calcVel_anon(this, i, $.$$index$as(this.particles, i));
    for (i = 0; $.CONSTANT6.$lt(i, this.count); ++i)
      t1.call$1(i);
  },
  drawSelf$1: function(i) {
    var p, t1, t2;
    p = $.$$index$as(this.particles, i);
    if ($.$$eq$o(i, 0) !== true)
      p.set$pos($.$$add$n(p.get$pos(), p.get$vel()));
    t1 = this.context;
    t1.beginPath$0();
    t2 = p.get$pos();
    t1.arc$6(t2.get$x(), t2.get$y(), p.r$0(), 0, 6.283185307179586, false);
    t1.closePath$0();
    t1.stroke$0();
  },
  Particles$2: function(context, count) {
    var random, t1, t2;
    this.particles = [];
    random = $.Random_Random(null);
    t1 = this.particles;
    t2 = this.context;
    $.add$1$a(t1, $.Particle$($.v2$($.$$div$n(t2.get$canvas().get$width(), 2), $.$$div$n(t2.get$canvas().get$height(), 2)), 350));
    this.forAll$1(new $.anon(this, random));
    this.count = $.$$add$n(this.count, 1);
  }
};
...
$$._PostMessageScheduler = {"": "_MicrotaskScheduler;_MICROTASK_MESSAGE,_nextMicrotaskFrameScheduled,_callback",
  ...
  get$_handleMessage: function() {
    return new $.Bound__handleMessage__PostMessageScheduler(this, "_handleMessage$1");
  },
...
$$.Main_start_anon = {"": "Closure;this_0",
  call$0: function() {
    var t1, t2;
    t1 = this.this_0;
    t1.set$_width($.callTypeCast(t1.get$canvas().get$parent(), "$isElement").clientWidth);
    t1.set$_height($.callTypeCast(t1.get$canvas().get$parent(), "$isElement").clientHeight);
    t2 = t1.get$_width();
      ...
      default:
        ...
        if (state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && typeof e === "object" && e !== null && (e.constructor === Array || e.$isList()))
          switch (state0) {
            ...
            case 3:
              state0 = 0;
              for (t1 = $.getInterceptor$a(copy); i < $length; ++i)
...
$$.Particles_draw_anon = {"": "Closure;this_0",
  call$1: function(i) {
    this.this_0.calcVel$1(i);
  }
};

$$.Particles_draw_anon0 = {"": "Closure;this_1",
  call$1: function(i) {
    this.this_1.drawSelf$1(i);
  }
};

$$.Particles_calcVel_anon = {"": "Closure;this_0,i_1,p_2",
  call$1: function(y) {
    var t1, p2, t2, t3, delta, dist2, m, t4, t5;
    if ($.$$eq$o(y, this.i_1) !== true) {
      t1 = this.this_0;
      p2 = $.$$index$as(t1.get$particles(), y);
      t2 = p2.get$pos();
      t3 = this.p_2;
      delta = $.$$sub$n(t2, t3.get$pos());
      dist2 = delta.mag2$0();
      m = $.$$mul$n(p2.get$m(), t3.get$m());
      t2 = $.$$div$n(t1.get$G(), t3.get$m());
      t4 = $.getInterceptor$n(m);
      t5 = $.$$mul$n(t1.get$attraction(), t4.$div(m, dist2));
      t4 = t4.$mul(m, t1.get$repulsion());
      dist2 = $.$$div$n(dist2, t1.get$radius());
      $.checkNum(dist2);
      $.checkNum(3);
      t5 = $.$$sub$n(t5, $.$$div$n(t4, Math.pow(dist2, 3)));
      if (typeof t5 !== "number")
        throw $.iae(t5);
      t3.set$vel($.$$add$n(t3.get$vel(), delta.norm$0().multN$1(t2 * t5)));
    }
    t1 = this.p_2;
    t1.set$vel(t1.get$vel().multN$1(0.999));
  }
};
...
$$.anon = {"": "Closure;this_0,random_1",
  call$1: function(i) {
    var t1, t2, t3, t4, t5, t6;
    t1 = this.random_1;
    t2 = t1.nextDouble$0();
    t3 = this.this_0;
    t4 = t3.get$context().get$canvas().get$width();
    if (typeof t4 !== "number")
      throw $.iae(t4);
    t5 = t1.nextDouble$0();
    t6 = t3.get$context().get$canvas().get$height();
    if (typeof t6 !== "number")
      throw $.iae(t6);
    $.add$1$a(t3.get$particles(), $.Particle$($.v2$(t2 * t4, t5 * t6), 50 + t1.nextDouble$0() * 50));
  }
};
...
$$._NativeJsSendPort_send_anon = {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    if (isolate == null)
      return;
    if (t2.get$_receivePort().get$_liblib1$_callback() == null)
      return;
...
$$._NativeJsSendPort_send__anon = {"": "Closure;box_0,this_4,shouldSerialize_5",
  call$0: function() {
    var t1, t2;
    t1 = this.this_4;
    if (t1.get$_receivePort().get$_liblib1$_callback() != null) {
      ...
      t2 = this.box_0;
      t1._liblib1$_callback$2(t2.msg_0, t2.reply_1);
    }
  },
  $is_TimerCallback0: true
};
...
$$.Bound__handleMessage__PostMessageScheduler = {"": "Closure;self,target",
  call$1: function(p0) {
    return this.self[this.target](p0);
  },
  $is_TimerCallback1: true
...
$.Particle$ = function(pos, m) {
  var t1 = new $.Particle(pos, null, m, null);
  t1.Particle$2(pos, m);
  return t1;
};

$.Particles$ = function(context, count) {
  var t1 = new $.Particles(context, null, count, 1, 1, 1, 1);
  t1.Particles$2(context, count);
  return t1;
};

$.main = function() {
  $.Main$(document.query$1("#container")).start$0();
};

$.Main$ = function(canvas) {
  return new $.Main(canvas, 20, null, null, null, null, null);
};
...
$.showFps = function(fps) {
  ...
  t2 = $.S($.CONSTANT6.toInt$0($.round$0$n($.fpsAverage))) + " fps";
  document.query$1("#notes").set$text(t2);
};
...
$._completeMicrotasks = function() {
  ...
  for (t1 = $.get$iterator$a(callbacks); t1.moveNext$0();)
...
$._completeMicrotasks.$is_TimerCallback0 = true;
...
$.CONSTANT15 = Isolate.makeConstantList(["childList", "attributes", "characterData", "subtree", "attributeOldValue", "characterDataOldValue"]);
$.CONSTANT10 = new $.ConstantMap(6, {childList: true, attributes: true, characterData: true, subtree: true, attributeOldValue: true, characterDataOldValue: true}, $.CONSTANT15);
...
Isolate.$lazy($, "GSlider", "GSlider", "get$GSlider", function() {
  return $.query("#GSlider");
});
Isolate.$lazy($, "repulsionSlider", "repulsionSlider", "get$repulsionSlider", function() {
  return $.query("#repulsionSlider");
});
Isolate.$lazy($, "radiusSlider", "radiusSlider", "get$radiusSlider", function() {
  return $.query("#radiusSlider");
});
Isolate.$lazy($, "attractionSlider", "attractionSlider", "get$attractionSlider", function() {
  return $.query("#attractionSlider");
});
...
//@ sourceMappingURL=fvg.dart.js.map
